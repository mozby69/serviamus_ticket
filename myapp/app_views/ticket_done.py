...
def fetch_tickets(request):
    if request.method == 'GET':
        ...
        tickets = ticket_list.objects.all().values('name', 'date_issued', 'valid_until', 'endorsed_to', 'relationship','csv_id','checkup_status')  # Select specific fields if needed
...
def save_checkup_status(request):
    ...
    try:
        ...
        update_ticket.checkup_status = "Done_Checkup"
